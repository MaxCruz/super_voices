...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { email: @administrator.email, last_name: @administrator.last_name, name: @administrator.name, password: @administrator.password } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { email: @administrator.email, last_name: @administrator.last_name, name: @administrator.name, password: @administrator.password } }
